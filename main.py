...
new_line()
st.markdown("<h1 style='text-align: center;'>FIFA WorldCup 2022 Analysis</h1>", unsafe_allow_html=True)
st.markdown("<h4 style='text-align: center;'>by Fahad Majeed</h4>", unsafe_allow_html=True)
st.markdown("<h5 style='text-align: center;'>PhD Scholar | Computer Vision Researcher | Sports Video Analyst</h5>", unsafe_allow_html=True)
st.markdown("<h6 style='text-align: center;'>College of Science and Engineering, Hamad Bin Khalifa University (HBKU), Qatar Foundation, Doha Qatar.</h6>", unsafe_allow_html=True)
...
id = None
st.image('game_schedule.png', use_column_width=True)
